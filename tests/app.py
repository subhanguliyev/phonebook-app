...
# Write a function named `find_persons` which finds persons' record using the keyword from the phonebook table in the
# db,and returns result as list of dictionary `[{'id': 1, 'name':'XXX', 'number': 'XXX'}]`.

# This function is to find my results that have "keyword" into database
...
def delete_person(name):
    ...
    delete = f"""
    DELETE FROM phonebook.phonebook
    WHERE id= {row[0]};
    """
